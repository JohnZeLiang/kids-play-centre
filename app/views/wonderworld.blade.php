...
<div class="container">
    ...
    <div class="jumbotron">	 
      ...
      <h3> Kids  Play Centre—Childcare & Kindergarten for Children aged 3-5 Years </h3>
	  
	  <div class="imgfl">
        <img  id="appletree" src="/img/IMGP2194.JPG" alt="Children sense apple tree blossom to ripe" style="max-width:100%; opacity: 1.0;">
        <div class="descontainer" style="height: 50px;">
           Children sense apple tree blossom to ripe
        </div>
       </div>

<p><b>Kids  Play Centre</b> is a long-day childcare centre that provides an integrated kindergarten program. 
The Centre is located in West Preston and has been under the same management since 1994.</p>




<p><b>Kids  Play Centre</b> provides a natural and nurturing environment for children. 
...
<p><b>Kids  Play Centre</b> is a small children’s service and is able provide a home-like environment for 22 
...
<p><b>Kids  Play Centre</b> provides an inclusive environment for the local community and welcomes all children 
and families.</p>

<h3>Nature-rich Environment</h3>
<p><b>Kids  Play Centre</b> has created a very green environment for children. Over the last 15 years 
