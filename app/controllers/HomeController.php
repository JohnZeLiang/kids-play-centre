    ...
    // check if the validator failed -----------------------
       if ($validator->fails()) {
		...
		//send email with the enquiry info to John
		 ...
		 'name2'=>Input::get('name2'),'date2'=>Input::get('date2'),'message1'=>Input::get('message')), function($message){$message->to('liangzehua8@hotmail.com', 'John')->subject('Customer enquiry');});
